...
```bash
cd; curl -#L https://github.com/puradox/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,.osx,LICENSE-MIT.txt}
```
...
| [![twitter/puradox](http://gravatar.com/avatar/24e08a9ea84deb17ae121074d0f17125?s=70)](http://twitter.com/puradox"Follow @puradoxon Twitter") |
|---|
| [Sam Balana](https://sambalana.com) |
